 ...
 */
export function resolveFace(ctx: Context | undefined, sessionId: string | undefined, key: string): ProjectionFace {
  ...
  const face: unknown = projections.faceOf(key)
 ...
 */
export function projectionSnapshot(ctx: Context | undefined, sessionId: string | undefined, key: string): unknown {
 ...
 */
export function useProjectionValue(ctx: Context | undefined, sessionId: string | undefined, key: string): unknown {
  const face = useMemo(() => resolveFace(ctx, sessionId, key), [ctx, sessionId, key])
