...
export const TODO_CELL_ID = 'todo'

/** Lower than the built-in's default 0 — the winner of the `todo` cell. */
export const TODO_SHADOW_PRIORITY = -1
...
function TodoDockShadow(): ReactNode {
  return null
}
 ...
 */
export function registerTodoDockShadow(ctx: Context): (() => void) | undefined {
  const slots = ctx.get('slots') as SlotsLike | undefined
  if (slots === undefined || typeof slots.inject !== 'function') return undefined
