	...
	factory: (require) => {
		...
		*/
		function PathRow(props) {
			...
			if (open === void 0) return (0, react.createElement)("li", { style: ROW_STYLE }, content, (0, react.createElement)("span", {
				style: PATH_STYLE,
				title
			}, label));
			return (0, react.createElement)("li", { style: ROW_STYLE }, content, (0, react.createElement)("button", {
				style: BUTTON_STYLE,
				title,
				onClick: () => {
					open(path);
